            ...
            for file in os.listdir(year_path):
                ...
                try:
                    with open(file_path, 'r') as json_file:
                        ...
                        for transaction in data['data']['districts']:
                            transaction_district = transaction['entityName']
...
top_transaction_dist_data = extract_transaction_data(root_directory)
print(top_transaction_dist_data)
...
try:
    ...
    if connection.is_connected():
        ...
        cursor.execute("TRUNCATE TABLE top_transaction_dist_data")

        # Insert new data into the MySQL database
        for index, row in top_transaction_dist_data.iterrows():
            sql_query = """
                INSERT INTO top_transaction_dist_data (State, Year, Quarter, District, Transaction_count, Transaction_amount)
                VALUES (%s, %s, %s, %s, %s, %s)
            """
